...
import { 
  HeartPulse, LayoutDashboard, Users, Cpu, Code2, 
      ...
      <AnimatePresence mode="wait">
        {!activated ? (
          ...
          <motion.div 
            ...
            initial={{ opacity: 0 }} 
            animate={{ opacity: 1 }} 
            style={{ width: '100%', maxWidth: '1280px', position: 'relative' }}
          >
            ...
            <>
              ...
              <footer className="app-footer" style={{ textAlign: 'center', padding: '3rem', opacity: 0.8 }}>
                <div style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'center', gap: '1.5rem' }}>
                  <button onClick={() => setShowCredits(true)} className="glass-btn"><Cpu size={18} /> Créditos</button>
